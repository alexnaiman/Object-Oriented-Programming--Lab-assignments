...
static char *opt_user_name = "REPLACE"; /* USERNAME */
static char *opt_password = "REPLACE"; /* PASSWORD */
...
void connecToMysql() {
	...
	con = driver->connect("tcp://127.0.0.1:3306", "REPLACE", "REPLACE"); // username, password
	con->setSchema("lab8");
